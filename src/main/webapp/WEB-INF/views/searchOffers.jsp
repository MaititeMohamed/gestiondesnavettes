	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="ml-auto">
			<c:if test="${not empty sessionScope.user}">
				<span class="navbar-text"> ${sessionScope.user.name} </span>
			</c:if>
		</div>
	</nav>
		...
		<div class="row">
			...
			<div class="col-md-2 bg-light"
				...
				<ul class="nav flex-column">
					<li class="nav-item"><a href="<%=request.getContextPath()%>/searchOffers" class="nav-link"
						id="searchLink">Search Subscription Offers</a></li>
						<li class="nav-item"><a href="<%=request.getContextPath()%>/userSubscriptionList" class="nav-link"
						id="searchLink2">User Subscription Requests</a></li>
				</ul>
			</div>
				...
				<div class="container mt-5">
					...
					<form action="searchOffers" method="POST" class="mb-5">
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label for="arrivalCity">Arrival City</label> <input type="text"
									id="arrivalCity" name="arrivalCity" class="form-control"
									required>
							</div>
							<div class="form-group col-md-3">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><a
									href="<%=request.getContextPath()%>/subscriptionRequest?shuttleId=1"
									class="btn btn-success">Subscribe</a></td>
							</tr>
							<%
							}
							%>
